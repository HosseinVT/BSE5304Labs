...
WXData=FillMissWX(declat=myflowgage$declat, declon=myflowgage$declon,
                  StnRadius=30,minstns=10,date_min="2018-01-01",
                  date_max="2023-01-01",targElev=myflowgage$elev,
                  method = "IDW",alfa=2)
...
#  myflowgage$area * 10^3 * 10^3 / res(mydem)[1]^2  #  number of cells in the basin
...
source("https://raw.githubusercontent.com/HosseinVT/BSE5304Labs/main/R/TMWBFuncs.R")
source("https://raw.githubusercontent.com/HosseinVT/BSE5304Labs/main/R/TISnow.R")
...
source("https://raw.githubusercontent.com/HosseinVT/BSE5304Labs/main/R/TMWBmodel.R")
source("https://raw.githubusercontent.com/HosseinVT/BSE5304Labs/main/R/NSE.R")

junkout = TMWBmodel(TMWB)
NSE(junkout$Qmm,junkout$Qpred)
...
legend("topright", c("Qmm", "Qpred"), col = c("red", "blue"),
       lty = 1:2, cex = 0.8)
grid()
plot(TMWBnew$Qmm,TMWBnew$Qpred, xlab = "Qmm (mm/day)", ylab="Qpred (mm/day)")
abline(a=0,b=1,col='red',lty = 1:2, cex = 1)
grid()
...
source("https://raw.githubusercontent.com/HosseinVT/BSE5304Labs/main/R/CNModel.R")

CNmodeldf = BasinData
CNmodeldf = CNmodel (CNmodeldf,CNavg = 39.86)

NSE(CNmodeldf$Qpred,CNmodeldf$Qmm)
NSeff(CNmodeldf$Qpred,CNmodeldf$Qmm)
plot(CNmodeldf$Qpred,col="red")
plot(CNmodeldf$Qmm,col="blue")
mean(CNmodeldf$Qmm)
mean(CNmodeldf$Qpred)


plot(CNmodeldf$date,CNmodeldf$Qmm,type = "l",col="red", xlab = "Year", ylab="Streamflow (mm/day)")
lines(CNmodeldf$date,CNmodeldf$Qpred,col="blue")
legend("topright", c("Qmm", "Qpred"), col = c("red", "blue"),
       lty = 1:2, cex = 0.8)
grid()

plot(CNmodeldf$Qmm,CNmodeldf$Qpred, xlab = "Qmm (mm/day)", ylab="Qpred (mm/day)")
abline(a=0,b=1,col='red',lty = 1:2, cex = 1)
grid()
