...
# Accorrding to Table 4:1-2  
MUSLE$Pusle [MUSLE$slp<0.03 & MUSLE$slp>0.001] = 0.6
MUSLE$Pusle [MUSLE$slp<0.06 & MUSLE$slp>0.03] = 0.5
MUSLE$Pusle [MUSLE$slp<0.09 & MUSLE$slp>0.06] = 0.5
MUSLE$Pusle [MUSLE$slp<0.13 & MUSLE$slp>0.09] = 0.6
MUSLE$Pusle [MUSLE$slp<0.17 & MUSLE$slp>0.13] = 0.7
MUSLE$Pusle [MUSLE$slp<0.21 & MUSLE$slp>0.17] = 0.8
MUSLE$Pusle [MUSLE$slp<0.25 & MUSLE$slp>0.21] = 0.9
#
# Cusle
MUSLE$Cusle=.20
#
...
TIC02$sed=(TIC02$Qpred*TIC02$qpeak*myflowgage$area/nTIclass*100)^.56*MUSLE$KCPLSCFRG118[1]    # Eq. 4:1.1.1 SWAT Theory
...
TIC03$sed=(TIC03$Qpred*TIC03$qpeak*myflowgage$area/nTIclass*100)^.56*MUSLE$KCPLSCFRG118[1]    # Eq. 4:1.1.1 SWAT Theory
...
TIC04$sed=(TIC04$Qpred*TIC04$qpeak*myflowgage$area/nTIclass*100)^.56*MUSLE$KCPLSCFRG118[1]    # Eq. 4:1.1.1 SWAT Theory
...
TIC05$sed=(TIC05$Qpred*TIC05$qpeak*myflowgage$area/nTIclass*100)^.56*MUSLE$KCPLSCFRG118[1]    # Eq. 4:1.1.1 SWAT Theory

TICtotal = data.frame(date = TIC01$date , sed = TIC01$sed+TIC02$sed+TIC03$sed+
                      TIC04$sed + TIC05$sed)
TICagg01 = data.frame(date = TIC01$date, sedagg = cumsum(TIC01$sed) )
TICagg02 = data.frame(date = TIC02$date,sedagg=cumsum(TIC02$sed))
TICagg03 = data.frame(date = TIC03$date,sedagg=cumsum(TIC03$sed))
TICagg04 = data.frame(date = TIC04$date,sedagg=cumsum(TIC04$sed))
TICagg05 = data.frame(date = TIC05$date,sedagg= cumsum(TIC05$sed))
TICaggt = data.frame(date = TICtotal$date,sedagg= cumsum(TICtotal$sed))


par(mfrow=c(3,2))
plot(TIC01$date,TIC01$sed,xlab = "Date", ylab="Sediment Loss",main="TI Class = 01")
plot(TIC02$date,TIC02$sed,xlab = "Date", ylab="Sediment Loss",main="TI Class = 02")
plot(TIC03$date,TIC03$sed,xlab = "Date", ylab="Sediment Loss",main="TI Class = 03")
plot(TIC04$date,TIC04$sed,xlab = "Date", ylab="Sediment Loss",main="TI Class = 04")
plot(TIC05$date,TIC05$sed,xlab = "Date", ylab="Sediment Loss",main="TI Class = 05")
plot(TICtotal$date,TICtotal$sed,xlab = "Date", ylab="Sediment Loss",main="Total TI Classes")
par(mfrow=c(1,1))

par(mfrow=c(3,2))
plot(TICagg01$date,TICagg01$sedagg,xlab = "Date", ylab="Sediment Loss",main="TI Class = 01")
plot(TICagg02$date,TICagg02$sedagg,xlab = "Date", ylab="Sediment Loss",main="TI Class = 02")
plot(TICagg03$date,TICagg03$sedagg,xlab = "Date", ylab="Sediment Loss",main="TI Class = 03")
plot(TICagg04$date,TICagg04$sedagg,xlab = "Date", ylab="Sediment Loss",main="TI Class = 04")
plot(TICagg05$date,TICagg05$sedagg,xlab = "Date", ylab="Sediment Loss",main="TI Class = 05")
plot(TICaggt$date,TICaggt$sedagg,xlab = "Date", ylab="Sediment Loss",main="Total TI Classes")
par(mfrow=c(1,1))

junkti1df1 = data.frame(x=TIC01$date,y=TIC01$sed,z=TICagg01$sedagg,means=mean(TIC01$sed, na.rm =TRUE)) 
junkti2df1 = data.frame(x=TIC02$date,y=TIC02$sed,z=TICagg02$sedagg,means=mean(TIC02$sed, na.rm =TRUE))
junkti3df1 = data.frame(x=TIC03$date,y=TIC03$sed,z=TICagg03$sedagg,means=mean(TIC03$sed, na.rm =TRUE))
junkti4df1 = data.frame(x=TIC04$date,y=TIC04$sed,z=TICagg04$sedagg,means=mean(TIC04$sed, na.rm =TRUE))
junkti5df1 = data.frame(x=TIC05$date,y=TIC05$sed,z=TICagg05$sedagg,means=mean(TIC05$sed, na.rm =TRUE))
junktiadf1 = data.frame(x=TICtotal$date,y=TICtotal$sed,z=TICaggt$sedagg,means=mean(TICtotal$sed, na.rm =TRUE))


junkti1df2 = data.frame(x=TIC01$date,y=TIC01$sed,z=TICagg01$sedagg,means=mean(TIC01$sed, na.rm =TRUE)) 
junkti2df2 = data.frame(x=TIC02$date,y=TIC02$sed,z=TICagg02$sedagg,means=mean(TIC02$sed, na.rm =TRUE))
junkti3df2 = data.frame(x=TIC03$date,y=TIC03$sed,z=TICagg03$sedagg,means=mean(TIC03$sed, na.rm =TRUE))
junkti4df2 = data.frame(x=TIC04$date,y=TIC04$sed,z=TICagg04$sedagg,means=mean(TIC04$sed, na.rm =TRUE))
junkti5df2 = data.frame(x=TIC05$date,y=TIC05$sed,z=TICagg05$sedagg,means=mean(TIC05$sed, na.rm =TRUE))
junktiadf2 = data.frame(x=TICtotal$date,y=TICtotal$sed,z=TICaggt$sedagg,means=mean(TICtotal$sed, na.rm =TRUE))


par(mfrow=c(3,2))
plot(junkti1df1$x,junkti1df1$y,pch=2, col="blue",xlab = "Date", ylab="Sediment Loss",main="TI Class = 01") +
  points(junkti1df2$x,junkti1df2$y,pch=19,col="red")
plot(junkti2df1$x,junkti2df1$y,pch=2, col="blue",xlab = "Date", ylab="Sediment Loss",main="TI Class = 02") +
  points(junkti2df2$x,junkti2df2$y,pch=19,col="red")
plot(junkti3df1$x,junkti3df1$y,pch=2, col="blue",xlab = "Date", ylab="Sediment Loss",main="TI Class = 03") +
  points(junkti3df2$x,junkti3df2$y,pch=19,col="red")
plot(junkti4df1$x,junkti4df1$y,pch=2, col="blue",xlab = "Date", ylab="Sediment Loss",main="TI Class = 04") +
  points(junkti4df2$x,junkti4df2$y,pch=19,col="red")
plot(junkti5df1$x,junkti5df1$y,pch=2, col="blue",xlab = "Date", ylab="Sediment Loss",main="TI Class = 05") +
  points(junkti5df2$x,junkti5df2$y,pch=19,col="red")
plot(junktiadf1$x,junktiadf1$y,pch=2, col="blue",xlab = "Date", ylab="Sediment Loss",main="Total TI Classes") +
  points(junktiadf2$x,junktiadf2$y,pch=19,col="red")
par(mfrow=c(1,1))

par(mfrow=c(3,2))
plot(junkti1df1$x,junkti1df1$z,pch=2, col="blue",xlab = "Date", ylab="Sediment Loss",main="TI Class = 01") +
  points(junkti1df2$x,junkti1df2$z,pch=19,col="red")
plot(junkti2df1$x,junkti2df1$z,pch=2, col="blue",xlab = "Date", ylab="Sediment Loss",main="TI Class = 02") +
  points(junkti2df2$x,junkti2df2$z,pch=19,col="red")
plot(junkti3df1$x,junkti3df1$z,pch=2, col="blue",xlab = "Date", ylab="Sediment Loss",main="TI Class = 03") +
  points(junkti3df2$x,junkti3df2$z,pch=19,col="red")
plot(junkti4df1$x,junkti4df1$z,pch=2, col="blue",xlab = "Date", ylab="Sediment Loss",main="TI Class = 04") +
  points(junkti4df2$x,junkti4df2$z,pch=19,col="red")
plot(junkti5df1$x,junkti5df1$z,pch=2, col="blue",xlab = "Date", ylab="Sediment Loss",main="TI Class = 05") +
  points(junkti5df2$x,junkti5df2$z,pch=19,col="red")
plot(junktiadf1$x,junktiadf1$z,pch=2, col="blue",xlab = "Date", ylab="Sediment Loss",main="Total TI Classes") +
  points(junktiadf2$x,junktiadf2$z,pch=19,col="red")
par(mfrow=c(1,1))


plot(junkti1df1$x,junktiadf1$y,ylim = c(0,10),pch=2, col="blue",xlab = "Date", ylab="Sediment Loss",main="Total TI Classes") +
  points(junktiadf2$x,junktiadf2$y,pch=19,col="red")
legend(x = "topleft", pch = c(2,19), text.font = 0.5, 
       col= c("blue","red"),text.col = "black", 
       legend=c("Pusle = 0.5", "Pusle according to Table 4:1-2"))

plot(junkti1df1$x,junkti1df1$z,ylim = c(0,2000),pch=2, col="blue",xlab = "Date", ylab="Sediment Loss",main="Total TI Classes") +
  points(junktiadf2$x,junktiadf2$z,pch=19,col="red")
legend(x = "topright", pch = c(2,19), text.font = 0.5, 
       col= c("blue","red"),text.col = "black", 
       legend=c("Pusle = 0.5", "Pusle according to Table 4:1-2"))

par(mfrow=c(1,2))
hist(junkti1df1$y, main="Pusle = 0.5")
hist(junktiadf2$y, main = "Pusle according to Table 4:1-2")
par(mfrow=c(1,1))


# Spatial map
ssurgo.geom_utm_crop2 = ssurgo.geom_utm_crop
ssurgo.geom_utm_crop2$msedm1 = c(junkti1df1m,junkti2df1m,junkti3df1m,junkti4df1m,junkti5df1m,junktiadf1m)
ssurgo.geom_utm_crop2$msedm2 = c(junkti1df2m,junkti2df2m,junkti3df2m,junkti4df2m,junkti5df2m,junktiadf2m)
#View(ssurgo.geom_utm_crop2$msedm1)
mysoil_utm2 <- as(ssurgo.geom_utm_crop2, "Spatial")
# Rasterizing for categorical analysis! 
rmysoil_utm2=rasterize(mysoil_utm2,TIC,field=as.numeric(mysoil_utm2$msedm1))
unique(rmysoil_utm2)
pacman::p_load(circlize)
plot(rmysoil_utm2,col=rand_color(length(unique(values(rmysoil_utm2)))))            
unique(rmysoil_utm2)
#
ratify(TIC)


spmap=ratify(TIC + (rmysoil_utm2))
unique(values(spmap))
sort(unique(values(spmap)))
length(unique(values(spmap)))
plot(spmap,col=rand_color(length(unique(values(spmap)))))


######## Model 2
mysoil_utm2 <- as(ssurgo.geom_utm_crop2, "Spatial") 
rmysoil_utm2=rasterize(mysoil_utm2,TIC,field=as.numeric(mysoil_utm2$msedm2))
unique(rmysoil_utm2)
pacman::p_load(circlize)
plot(rmysoil_utm2,col=rand_color(length(unique(values(rmysoil_utm2)))))            
unique(rmysoil_utm2)
...
# Spatial Map2 #
# first Model
MSEDTIC01 = junkti1df1$means*365
MSEDTIC02 = junkti2df1$means*365
MSEDTIC03 = junkti3df1$means*365
MSEDTIC04 = junkti4df1$means*365
MSEDTIC05 = junkti5df1$means*365


L <- c(1,MSEDTIC01, 2,MSEDTIC02,3,MSEDTIC03,4,MSEDTIC04,5,MSEDTIC05)
label <- matrix(L, ncol=2, byrow=TRUE)
updated_TIC <- reclassify(TIC, label)
plot(updated_TIC)
# Second Model
MSEDTIC01 = junkti1df2$means*365
MSEDTIC02 = junkti2df2$means*365
MSEDTIC03 = junkti3df2$means*365
MSEDTIC04 = junkti4df2$means*365
MSEDTIC05 = junkti5df2$means*365
